...
/*SF_DATA;ver:1.03;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:False,lprd:False,rprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,rpth:0,hqsc:True,hqlp:False,tesm:0,blpr:0,bsrc:0,bdst:1,culm:2,dpts:2,wrdp:False,dith:2,ufog:True,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:2397,x:33022,y:32711,varname:node_2397,prsc:2|diff-5316-OUT,spec-3636-OUT,gloss-6641-OUT,normal-7213-RGB,transm-4222-OUT,lwrap-4222-OUT,alpha-2748-OUT,refract-8574-OUT;n:type:ShaderForge.SFN_ComponentMask,id:91,x:32281,y:32913,varname:node_91,prsc:2,cc1:0,cc2:1,cc3:-1,cc4:-1|IN-7213-RGB;n:type:ShaderForge.SFN_Multiply,id:9028,x:32511,y:32997,varname:node_9028,prsc:2|A-91-OUT,B-6398-OUT;n:type:ShaderForge.SFN_Fresnel,id:5316,x:32265,y:32629,varname:node_5316,prsc:2;n:type:ShaderForge.SFN_Vector1,id:4222,x:32458,y:32894,varname:node_4222,prsc:2,v1:1;n:type:ShaderForge.SFN_Tex2d,id:7213,x:32101,y:32927,ptovrint:False,ptlb:Texture,ptin:_Texture,varname:node_7213,prsc:2,ntxv:3,isnm:True|UVIN-7100-UVOUT;n:type:ShaderForge.SFN_Vector1,id:3636,x:32458,y:32734,varname:node_3636,prsc:2,v1:6;n:type:ShaderForge.SFN_Vector1,id:6641,x:32413,y:32788,varname:node_6641,prsc:2,v1:0.8;n:type:ShaderForge.SFN_Panner,id:7100,x:31850,y:32927,varname:node_7100,prsc:2,spu:-6,spv:-10;n:type:ShaderForge.SFN_Slider,id:6398,x:31981,y:33183,ptovrint:False,ptlb:Distortion_Strength,ptin:_Distortion_Strength,varname:node_6398,prsc:2,min:0,cur:0,max:0.1;n:type:ShaderForge.SFN_Tex2d,id:3875,x:32534,y:33148,ptovrint:False,ptlb:Mask,ptin:_Mask,varname:node_3875,prsc:2,tex:5881beee1f3bab347b0a3302e6dddd17,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Vector1,id:2748,x:32779,y:33220,varname:node_2748,prsc:2,v1:0;n:type:ShaderForge.SFN_Lerp,id:8574,x:32734,y:33044,varname:node_8574,prsc:2|A-8736-OUT,B-9028-OUT,T-3875-R;n:type:ShaderForge.SFN_Vector1,id:8736,x:32643,y:32958,varname:node_8736,prsc:2,v1:0;proporder:7213-3875-6398;pass:END;sub:END;*/
    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                float node_8736 = 0.0;
                float4 node_3790 = _Time + _TimeEditor;
                float2 node_7100 = (i.uv0+node_3790.g*float2(-6,-10));
...
/// Final Color:
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_7100 = (i.uv0+node_5741.g*float2(-6,-10));
                float3 _Texture_var = UnpackNormal(tex2D(_Texture,TRANSFORM_TEX(node_7100, _Texture)));
                float4 _Mask_var = tex2D(_Mask,TRANSFORM_TEX(i.uv0, _Mask));
                float2 sceneUVs = float2(1,grabSign)*i.screenPos.xy*0.5+0.5 + lerp(float2(node_8736,node_8736),(_Texture_var.rgb.rg*_Distortion_Strength),_Mask_var.r);
                float4 sceneColor = tex2D(_GrabTexture, sceneUVs);
